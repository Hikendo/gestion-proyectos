...
const handleGetData = async () => {
    loader.value = true;
    const response = await ticketsService.index(projectId(), { page: paginacionYquery.value.page, query: paginacionYquery.value.query });
        ...
        <VCardItem class="pb-4">
          <VCardTitle>
            <div class="d-flex justify-space-between flex-wrap">
              <h4 class="text-h4 text-wrap me-3">Listado de <strong>Tickets</strong></h4>
              <VBtn variant="flat"
