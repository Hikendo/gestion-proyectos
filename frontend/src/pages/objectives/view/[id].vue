                ...
                <VCardItem>
                    <VCardTitle class="d-flex justify-space-between flex-wrap align-center">
                        <span class="d-flex align-center gap-2">
                            <VIcon icon="mdi-flag-checkered" color="primary" />Objetivo: {{ item.title }}
                        </span>
                        <div class="d-flex gap-2">
                            <VBtn variant="outlined" prepend-icon="mdi-arrow-left"
                                :to="{ name: 'objectives', params: { projectId } }">Volver</VBtn>
                            <VBtn v-if="canAction('Objetivo.Update')" variant="tonal" color="warning"
                                :to="{ name: 'objectives-id', params: { projectId, id } }" prepend-icon="mdi-pencil">
                                Editar</VBtn>
                        </div>
                    </VCardTitle>
                </VCardItem>
