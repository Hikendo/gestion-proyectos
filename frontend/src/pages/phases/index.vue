...
const handleDestroy = async () => {
    ...
    if (response.status) {
        snackbar.value = { show: true, text: 'Fase eliminado', color: 'success' };
        handleGetData();
    }
    loader.value = false;
        ...
        <VCardItem class="pb-4">
          <VCardTitle>
            <div class="d-flex justify-space-between flex-wrap">
              <h4 class="text-h4 text-wrap me-3"><strong>Fases del proyecto</strong></h4>
              <div class="d-flex gap-2">
                ...
                <VBtn variant="flat"
                  :to="{ name: 'phases-new', params: { projectId: projectId() } }"
                  v-if="canAction('Fase.Store')"
